...
public class SFXManager : MonoBehaviour
{
    ...
    static public void PlayTutorialSFX() => Instance.PlayTutorialSFX_Internal();
    private void PlayTutorialSFX_Internal() => PlaySFX_Internal(m_sfxCollection[9].Clip, m_sfxCollection[9].Volume);
